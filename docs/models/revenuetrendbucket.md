...
| `groupBreakdown`                                                                              | [models.GroupTrendEntry](../models/grouptrendentry.md)[]                                      | :heavy_minus_sign:                                                                            | Per-group trend entries (present when groupBy=plan or groupBy=customer)                       |