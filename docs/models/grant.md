...
| `resetMaxRollover`                                                                                  | *number*                                                                                            | :heavy_minus_sign:                                                                                  | Maximum balance carried over at the entitlement's reset boundary.                                   |
| `resetMinRollover`                                                                                  | *number*                                                                                            | :heavy_minus_sign:                                                                                  | Minimum balance at the entitlement's reset boundary.                                                |