...
| `featureType`                                                                                          | [models.FeatureTypeEnum](../models/featuretypeenum.md)                                                 | :heavy_check_mark:                                                                                     | The type of feature: `boolean` (on/off), `static` (with config), or `metered` (usage-based).           |
...
| `balance`                                                                                              | *number*                                                                                               | :heavy_minus_sign:                                                                                     | Remaining grant balance. Only present for `metered` features.                                          |
| `usageInPeriod`                                                                                        | *number*                                                                                               | :heavy_minus_sign:                                                                                     | Total usage in the current period. Only present for `metered` features.                                |
| `overage`                                                                                              | *number*                                                                                               | :heavy_minus_sign:                                                                                     | Amount of overage beyond granted balance. Only present for `metered` features.                         |
| `currentPeriodStart`                                                                                   | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)          | :heavy_minus_sign:                                                                                     | Start of the current usage period. Only present for `metered` features with a usage period configured. |
| `currentPeriodEnd`                                                                                     | [Date](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date)          | :heavy_minus_sign:                                                                                     | End of the current usage period. Only present for `metered` features with a usage period configured.   |