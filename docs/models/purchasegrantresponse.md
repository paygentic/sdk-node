...
| `paymentSessions`                                                                                | [models.PurchaseGrantResponsePaymentSession](../models/purchasegrantresponsepaymentsession.md)[] | :heavy_check_mark:                                                                               | Payment session(s) for the customer to complete the purchase.                                    |