...
<!-- UsageSnippet language="typescript" operationID="listPayments" method="get" path="/v0/payments" -->
```typescript
...
async function run() {
  const result = await paygentic.payments.list({});
...
import { paymentsList } from "@paygentic/sdk/funcs/paymentsList.js";
...
async function run() {
  const res = await paymentsList(paygentic, {});
  if (res.ok) {
...
<!-- UsageSnippet language="typescript" operationID="createPayment" method="post" path="/v0/payments" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
async function run() {
  const result = await paygentic.payments.create({
    amount: "10.50",
    currency: "USD",
...
```typescript
import { PaygenticCore } from "@paygentic/sdk/core.js";
import { paymentsCreate } from "@paygentic/sdk/funcs/paymentsCreate.js";
...
async function run() {
  const res = await paymentsCreate(paygentic, {
    amount: "10.50",
    currency: "USD",
    idempotencyKey: "order_12345",
    reference: "Order #12345",
...
<!-- UsageSnippet language="typescript" operationID="getPayment" method="get" path="/v0/payments/{id}" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
async function run() {
  const result = await paygentic.payments.get({
    id: "<id>",
  });
...
```typescript
import { PaygenticCore } from "@paygentic/sdk/core.js";
import { paymentsGet } from "@paygentic/sdk/funcs/paymentsGet.js";
...
async function run() {
  const res = await paymentsGet(paygentic, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
