...
<!-- UsageSnippet language="typescript" operationID="createDispute" method="post" path="/v0/disputes" -->
```typescript
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [models.CreateDisputeRequest](../../models/createdisputerequest.md)                                                                                                            | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
...
**Promise\<[models.Dispute](../../models/dispute.md)\>**
...
| errors.ErrorT                | 403, 409                     | application/json             |
...
<!-- UsageSnippet language="typescript" operationID="listDisputes" method="get" path="/v0/disputes" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
