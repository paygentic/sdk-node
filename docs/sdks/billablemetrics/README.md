...
<!-- UsageSnippet language="typescript" operationID="createBillableMetric" method="post" path="/v0/billableMetrics" -->
```typescript
...
**Promise\<[models.BillableMetric](../../models/billablemetric.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="listBillableMetrics" method="get" path="/v0/billableMetrics" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
**Promise\<[operations.ListBillableMetricsResponse](../../models/operations/listbillablemetricsresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="getBillableMetric" method="get" path="/v0/billableMetrics/{id}" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.GetBillableMetricRequest](../../models/operations/getbillablemetricrequest.md)                                                                                     | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="updateBillableMetric" method="patch" path="/v0/billableMetrics/{id}" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
| Parameter                                                                                                                                                                      | Type                                                                                                                                                                           | Required                                                                                                                                                                       | Description                                                                                                                                                                    |
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `request`                                                                                                                                                                      | [operations.UpdateBillableMetricRequest](../../models/operations/updatebillablemetricrequest.md)                                                                               | :heavy_check_mark:                                                                                                                                                             | The request object to use for the request.                                                                                                                                     |
| `options`                                                                                                                                                                      | RequestOptions                                                                                                                                                                 | :heavy_minus_sign:                                                                                                                                                             | Used to set various options for making HTTP requests.                                                                                                                          |
| `options.fetchOptions`                                                                                                                                                         | [RequestInit](https://developer.mozilla.org/en-US/docs/Web/API/Request/Request#options)                                                                                        | :heavy_minus_sign:                                                                                                                                                             | Options that are passed to the underlying HTTP request. This can be used to inject extra headers for examples. All `Request` options, except `method` and `body`, are allowed. |
| `options.retries`                                                                                                                                                              | [RetryConfig](../../lib/utils/retryconfig.md)                                                                                                                                  | :heavy_minus_sign:                                                                                                                                                             | Enables retrying HTTP requests under certain failure conditions.                                                                                                               |
...
<!-- UsageSnippet language="typescript" operationID="getBillableMetricMeter" method="get" path="/v0/billableMetrics/{id}/meter" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
async function run() {
  const result = await paygentic.billableMetrics.meter({
    id: "<id>",
    from: new Date("2024-12-02T03:30:12.536Z"),
    to: new Date("2024-06-19T00:01:21.924Z"),
  });
...
```typescript
import { PaygenticCore } from "@paygentic/sdk/core.js";
import { billableMetricsMeter } from "@paygentic/sdk/funcs/billableMetricsMeter.js";
...
async function run() {
  const res = await billableMetricsMeter(paygentic, {
    id: "<id>",
    from: new Date("2024-12-02T03:30:12.536Z"),
    to: new Date("2024-06-19T00:01:21.924Z"),
  });
  if (res.ok) {
    ...
    console.log("billableMetricsMeter failed:", res.error);
  }
}
...
<!-- UsageSnippet language="typescript" operationID="listBillableMetricEvents" method="get" path="/v0/billableMetrics/{id}/events" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
async function run() {
  const result = await paygentic.billableMetrics.listEvents({
    id: "<id>",
    from: new Date("2024-09-28T08:04:20.478Z"),
    to: new Date("2025-07-03T05:08:35.498Z"),
  });
...
```typescript
import { PaygenticCore } from "@paygentic/sdk/core.js";
import { billableMetricsListEvents } from "@paygentic/sdk/funcs/billableMetricsListEvents.js";
...
async function run() {
  const res = await billableMetricsListEvents(paygentic, {
    id: "<id>",
    from: new Date("2024-09-28T08:04:20.478Z"),
    to: new Date("2025-07-03T05:08:35.498Z"),
  });
  if (res.ok) {
    ...
    console.log("billableMetricsListEvents failed:", res.error);
  }
}
...
**Promise\<[models.MeterEventList](../../models/metereventlist.md)\>**
