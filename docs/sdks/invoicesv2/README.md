...
<!-- UsageSnippet language="typescript" operationID="listInvoices" method="get" path="/v2/invoices" -->
```typescript
...
<!-- UsageSnippet language="typescript" operationID="getInvoice" method="get" path="/v2/invoices/{id}" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
<!-- UsageSnippet language="typescript" operationID="getInvoiceLineItems" method="get" path="/v2/invoices/{id}/lineItems" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
**Promise\<[models.InvoiceLineItemsResponse](../../models/invoicelineitemsresponse.md)\>**
...
<!-- UsageSnippet language="typescript" operationID="downloadInvoicePdf" method="get" path="/v2/invoices/{id}/pdf" -->
```typescript
import { Paygentic } from "@paygentic/sdk";
...
async function run() {
  const result = await paygentic.invoicesV2.downloadInvoicePdf({
    id: "<id>",
  });
...
```typescript
import { PaygenticCore } from "@paygentic/sdk/core.js";
import { invoicesV2DownloadInvoicePdf } from "@paygentic/sdk/funcs/invoicesV2DownloadInvoicePdf.js";
...
async function run() {
  const res = await invoicesV2DownloadInvoicePdf(paygentic, {
    id: "<id>",
  });
  if (res.ok) {
    const { value: result } = res;
    ...
    console.log("invoicesV2DownloadInvoicePdf failed:", res.error);
  }
}
