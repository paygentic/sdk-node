 ...
 */
export function billingSchedulesGenerateScheduleInvoices(
  client: PaygenticCore,
  request: operations.GenerateScheduleInvoicesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.GenerateScheduleInvoicesResponse,
    | errors.BadRequest
    | errors.ErrorT
    | PaygenticError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GenerateScheduleInvoicesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v0/billingSchedules/{id}/invoices")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, operations.GenerateScheduleInvoicesResponse$inboundSchema),
