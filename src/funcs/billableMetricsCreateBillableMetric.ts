 ...
 */
export function billableMetricsCreateBillableMetric(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateBillableMetricRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.BillableMetric$inboundSchema),
