 ...
 */
export function plansListPlanVersions(
  client: PaygenticCore,
  request: operations.ListPlanVersionsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListPlanVersionsResponse,
    | errors.BadRequest
    | errors.ErrorT
    | PaygenticError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListPlanVersionsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v0/plans/{id}/versions")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListPlanVersionsResponse$inboundSchema),
