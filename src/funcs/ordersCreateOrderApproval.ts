 ...
 */
export function ordersCreateOrderApproval(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.CreateOrderApprovalRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.CreateOrderApprovalRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v0/orders/{orderId}/approvals")(pathParams);
