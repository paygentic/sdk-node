 ...
 */
export function billableMetricsListEvents(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBillableMetricEventsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.MeterEventList$inboundSchema),
