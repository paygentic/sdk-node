 ...
 * Update Rule
 */
export function sourcesUpdateSourceRule(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateSourceRuleRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateRuleRequest, { explode: true });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SourceRule$inboundSchema),
