...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListFeesRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListFeesResponse$inboundSchema),
