 ...
 */
export function invoicesV2GetInvoiceLineItems(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.GetInvoiceLineItemsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.InvoiceLineItemsResponse$inboundSchema),
