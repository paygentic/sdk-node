 ...
 */
export function subscriptionsReconcileSubscriptionFeatures(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ReconcileSubscriptionFeaturesRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v0/subscriptions/{id}/reconciliations")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json([200, 201], models.SubscriptionReconciliation$inboundSchema),
    M.jsonErr(400, errors.BadRequest$inboundSchema),
    M.jsonErr([401, 403, 404, 429], errors.ErrorT$inboundSchema),
