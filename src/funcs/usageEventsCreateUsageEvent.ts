 ...
 */
export function usageEventsCreateUsageEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) => models.CreateUsageEventRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v0/usage")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.UsageEvent$inboundSchema),
