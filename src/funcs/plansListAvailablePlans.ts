 ...
 */
export function plansListAvailablePlans(
  client: PaygenticCore,
  request: operations.ListAvailablePlansRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListAvailablePlansResponse,
    | errors.BadRequest
    | errors.ErrorT
    | PaygenticError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListAvailablePlansRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v0/plans/available")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListAvailablePlansResponse$inboundSchema),
