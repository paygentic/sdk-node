 ...
 */
export function sourcesListSourceEvents(
  client: PaygenticCore,
  request: operations.ListSourceEventsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListSourceEventsResponse,
    | errors.ErrorT
    | PaygenticError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListSourceEventsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSourceEventsResponse$inboundSchema),
