 ...
 * Get
 */
export function featuresGetFeature(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFeatureRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v0/features/{id}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.Feature$inboundSchema),
