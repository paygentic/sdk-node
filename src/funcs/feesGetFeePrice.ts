 ...
 */
export function feesGetFeePrice(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.GetFeePriceRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v0/fees/{id}/price/{subscriptionId}")(pathParams);
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.FeePrice$inboundSchema),
