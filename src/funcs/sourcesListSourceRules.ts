 ...
 */
export function sourcesListSourceRules(
  client: PaygenticCore,
  request: operations.ListSourceRulesRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListSourceRulesResponse,
    | errors.BadRequest
    | errors.ErrorT
    | PaygenticError
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ListSourceRulesRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v0/sourceRules")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSourceRulesResponse$inboundSchema),
