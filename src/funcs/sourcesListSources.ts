 ...
 * List
 */
export function sourcesListSources(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListSourcesRequest$outboundSchema.optional().parse(value),
  ...
  const path = pathToFunc("/v0/sources")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListSourcesResponse$inboundSchema),
