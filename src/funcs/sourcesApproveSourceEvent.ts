 ...
 */
export function sourcesApproveSourceEvent(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.ApproveSourceEventRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.SourceEvent$inboundSchema),
