 ...
 */
export function testClocksAdvanceTestClock(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.AdvanceTestClockRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.TestClock$inboundSchema),
