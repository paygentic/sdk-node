 ...
 */
export function sourcesBulkRejectSourceEvents(
  client: PaygenticCore,
  request: operations.BulkRejectSourceEventsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkRejectSourceEventsResponse,
    | errors.BadRequest
    | errors.ErrorT
    | PaygenticError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkRejectSourceEventsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BulkRejectSourceEventsResponse$inboundSchema),
