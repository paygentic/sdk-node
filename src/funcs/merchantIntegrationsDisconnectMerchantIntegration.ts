 ...
 */
export function merchantIntegrationsDisconnectMerchantIntegration(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DisconnectMerchantIntegrationRequest$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v0/merchantIntegrations/{id}/disconnect")(
    pathParams,
  );
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.MerchantIntegration$inboundSchema),
