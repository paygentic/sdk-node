...
> {
  const parsed = safeParse(
    request,
    (value) => operations.MintPlanVersionRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.MintPlanVersionRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, models.PlanVersion$inboundSchema),
