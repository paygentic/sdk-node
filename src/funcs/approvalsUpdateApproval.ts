 ...
 */
export function approvalsUpdateApproval(
...
> {
  const parsed = safeParse(
    request,
    (value) => operations.UpdateApprovalRequest$outboundSchema.parse(value),
  ...
  const body = encodeJSON("body", payload.UpdateApprovalRequest, {
    explode: true,
  });
  ...
  const path = pathToFunc("/v0/approvals/{id}")(pathParams);
