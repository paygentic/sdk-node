 ...
 */
export function usageEventsBatchCreateUsageEvents(
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BatchCreateUsageEventsRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v0/usage/batch")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json([201, 207], models.BatchUsageEventResponse$inboundSchema),
