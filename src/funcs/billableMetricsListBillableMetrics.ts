 ...
 * List
 */
export function billableMetricsListBillableMetrics(
  client: PaygenticCore,
  request: operations.ListBillableMetricsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.ListBillableMetricsResponse,
    | errors.ErrorT
    | PaygenticError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.ListBillableMetricsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.ListBillableMetricsResponse$inboundSchema),
