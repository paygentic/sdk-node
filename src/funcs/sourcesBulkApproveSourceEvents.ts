 ...
 */
export function sourcesBulkApproveSourceEvents(
  client: PaygenticCore,
  request: operations.BulkApproveSourceEventsRequest,
  options?: RequestOptions,
): APIPromise<
  Result<
    operations.BulkApproveSourceEventsResponse,
    | errors.BadRequest
    | errors.ErrorT
    | PaygenticError
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.BulkApproveSourceEventsRequest$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, operations.BulkApproveSourceEventsResponse$inboundSchema),
