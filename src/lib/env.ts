...
export interface Env {
  PAYGENTIC_BEARER_AUTH?: string | undefined;

  PAYGENTIC_DEBUG?: boolean | undefined;
}

export const envSchema: z.ZodType<Env, z.ZodTypeDef, unknown> = z.object({
  PAYGENTIC_BEARER_AUTH: z.string().optional(),

  PAYGENTIC_DEBUG: z.coerce.boolean().optional(),
});
